...
// --- OBTENER CITAS DE UN PACIENTE (Próximas y Históricas) ---
export const getCitasByPacienteId = async (req, res) => {
    try {
        const { pacienteId } = req.params;
        const now = new Date();
        
        // Obtiene las citas pendientes (Fecha y hora mayor o igual a la actual)
        ...
        // Obtiene las citas históricas (Fecha y hora menor a la actual o Completadas/Canceladas)
...
export const createCita = async (req, res) => {
    try {
        ...
        // El medicoId debe ser el ID del User con el que se agendará la cita (que puede ser el usuario logueado o uno seleccionado)
